...
import { MovieEditSkeleton } from '@/components/movie-edit-skeleton';
...
export default function EditarFilme() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Remover campos vazios antes da validação
      const formData = {
        ...form,
        trailerUrl: form.trailerUrl || undefined // Se vazio, define como undefined
      };
      ...
      const res = await fetch(`/api/filmes/${params.id}`, {
        method: 'PUT',
      ...
      setError(err instanceof Error ? err.message : 'Erro ao atualizar filme');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleTMDBSelect = (movieData: {
    ...
    toast.success('Informações do filme atualizadas!');
  };
